@echo off
title Activate Microsoft Office 2021 (ALL versions) for FREE - BiosArchives.com
cls
echo =====================================================================================
...
cscript //nologo ospp.vbs /act | find /i "successful" && (
    ...
    echo =====================================================================================
    echo.
    echo #My official blog: BiosArchives.com
    echo.
    echo #How it works: bit.ly/kms-server
    echo.
    echo #Please feel free to contact me at BiosArchives.com@gmail.com if you have any questions or concerns.
    echo.
    echo #Please consider supporting this project: donate.BiosArchives.com
    ...
    explorer "http://BiosArchives.com"
    goto halt
) || (
